...
const team = [
  {
    ...
    bio: 'A medical practitioner with a Master\'s in Business Administration, Dr. Obinna brings over 10 years of experience in preventive health and healthcare leadership. He leads the foundation\'s strategic vision and partnerships across Africa and beyond, championing innovative approaches to early detection, health education, and community-centered prevention.',
    image: '/Obinna.jpeg',
  },
  {
    name: 'Dr. Obumneme Omogo',
    role: 'Medical Director',
    bio: 'A resident in community medicine and masters in public health promotion, Dr. Obum oversees all clinical programs and ensures evidence-based approaches across our initiatives.',
    image: '/Obum.jpeg',
  },
  {
    name: 'Nurse Okafor Angela',
  ...
  {
    name: 'Miss Chidiogo Okoro',
    role: 'Head of Community Outreach',
    bio: 'Chidiogo is a Medical Laboratory Scientist and Wellness Coach whose passion for global health and holistic wellness drives her commitment to helping individuals live healthier and better lives through personal coaching, health education, and sensitization',
    image: '/Chidiogo.jpeg',
  },
  {
